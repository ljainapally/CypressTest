...
Create Certificates of Record with existing user

Scenario: Create Certificate of Record with ArtworkType Sculpture
...
Scenario: Create Certificate of Record with ArtworkType Print
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Bridge.jpg"
    And I select the image as "Front Image"
    And I select artistname as "Pal Angelo Funk" 
...
Scenario: Create Certificate of Record with ArtworkType Photo
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Market.jpg"
    And I select the image as "Front Image"
    And I select artistname as "Cori de Veer" 
...
Scenario: Create Certificate of Record with ArtworkType Collectible
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Smile.jpg"
    And I select the image as "Front Image"
    And I select artistname as "Jan Kalab" 
...
Scenario: Create Certificate of Record with ArtworkType Digital Artwork
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Twins .jpg"
    And I select the image as "Front Image"
    And I select artistname as "Michael Govan" 
...
Scenario: Create Certificate of Record with ArtworkType Mixed Media
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Untitled 1974.jpg"
    And I select the image as "Front Image"
    And I select artistname as "Max Weisel" 
...
Scenario: Create Certificate of Record with ArtworkType Ephemera
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/High Noon .jpg"
    And I select the image as "Front Image"
    And I select artistname as "Norman Adams" 
...
Scenario: Create Certificate of Record with ArtworkType Book
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Military Man.jpg"
    And I select the image as "Front Image"
    And I select artistname as "Linda Albertano" 
...
Scenario: Create Certificate of Record with ArtworkType Painting
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Little Afghan.jpg"
...
Scenario: Create Certificate of Record with ArtworkType Furniture
  Given I am logged in and go to certify tab
...
Scenario: Create Certificate of Record with ArtworkType Drawing
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/High Noon .jpg"
    And I select the image as "Front Image"
    And I select artistname as "Linda Albertano"
...
Scenario: Create Certificate of Record with ArtworkType Picture
  Given I am logged in and go to certify tab
  ...
  Scenario: Create Certificate of Record with ArtworkType Design
  Given I am logged in and go to certify tab
  Given I Upload the image "/TestImages/Military Man.jpg"
    And I select the image as "Front Image"
    And I select artistname as "Linda Albertano"
